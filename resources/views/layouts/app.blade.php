...
<head>
  ...
  <link rel="icon" type="image/png" href="{{asset('img/now-logo.png')}}">
  ...
  <script type="text/javascript" src="{{asset('js/core/bootstrap.min.j') }}"></script>
  ...
  <script src="{{asset('js/now-ui-kit.js?v=1.3.0') }}"></script>
  <script>
